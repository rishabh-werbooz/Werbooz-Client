        ...
        <>
            <div className={styles.Blog_Card}>
                <div className={styles.BlogImg}>
                    ...
                    <div className={`${styles.keywords} d-flex justify-content-start flex-wrap gap-05`}>
                        {data.keywords.map((keyword, index) => (
                            <span key={index} className={`${styles.btn} fw-700 font-sm`}>
                                {keyword}
                            </span>
                        ))}
                    </div>
                ...
                <div>
                    ...
                    />
                    <Description description={data.description} className="mb-1" />
                    <Link href={data.link} className={`${styles.blog_link} fw-600 d-flex align-items-center gap-05`}>
